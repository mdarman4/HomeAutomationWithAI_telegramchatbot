...
# For producing sound that telegram services are live now on coming to online
...
# Formatting the sentences generated by LLM
...
def GoogleGenAI(command):
    ...
    if data['if_the_query_doesnt_seem_to_be_switching_on_or_off_then_turn_on_AI_mode']!=True:    
        ...
        #Iterating various electrical equipments for on
        ...
        # Iterating various electrical equipment to Switch OFF
